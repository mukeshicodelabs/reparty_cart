...
import css from './HelpCenterPageTabs.module.css';
...
const HelpCenterPageTabsComponent = props => {
    ...
    const tabs = [
        {
            text: <FormattedMessage id="HelpCenterPageTabs.faq" />,
            selected: currentPage === 'FAQPage',
            id: 'FAQPageTab',
            linkProps: {
                name: 'FAQPage',
            },
        ...
        {
            text: <FormattedMessage id="HelpCenterPageTabs.contactSupport" />,
            selected: currentPage === 'ContactSupportPage',
            id: 'ContactSupportPageTab',
            linkProps: {
                name: 'ContactSupportPage',
            },
        },
        {
            text: <FormattedMessage id="HelpCenterPageTabs.policies" />,
            selected: currentPage === 'PolicyPage',
            id: 'PolicyPageTab',
            linkProps: {
                name: 'PolicyPage',
            },
...
HelpCenterPageTabsComponent.defaultProps = {
    className: null,
    rootClassName: null,
    children: null,
    currentPage: null,
...
HelpCenterPageTabsComponent.propTypes = {
    children: node,
    className: string,
...
const HelpCenterPageTabs = compose(withViewport)(
    HelpCenterPageTabsComponent
);

export default HelpCenterPageTabs;
