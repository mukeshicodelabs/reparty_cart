      ...
      <FinalForm
        ...
        render={fieldRenderProps => {
          ...
          const countryLabel = intl.formatMessage({
            id: 'ProfileSettingsForm.counrtyLabel',
          });
          const countryPlaceholder = intl.formatMessage({
            id: 'ProfileSettingsForm.counrtyPlaceholder',
          });
          // Zipcode
            ...
            profileImage.imageId || fileUploadInProgress ? (
              <div className={css.avatarContainer}>
                ...
                <div className={css.changeAvatar}>
                  <BrandIconCard type="editprofile" />
              ...
              <div className={css.formWrapper}>
                ...
                <FieldSelect
                  ...
                  validate={validators.minLength(
                    intl.formatMessage({ id: 'ProfileSettingsForm.stateMinLength' }),
                    1 // Require at least one state
                  )}
                >
                ...
                <FieldSelect
                  ...
                  label={countryLabel}
                  validate={validators.minLength(
                    intl.formatMessage({ id: 'ProfileSettingsForm.countryMinLength' }),
                    1 // Require at least one country
                  )}
                >
                  <option disabled value="">
                    {countryPlaceholder}
