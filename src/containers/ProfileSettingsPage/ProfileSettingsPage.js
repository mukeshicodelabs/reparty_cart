...
export const ProfileSettingsPageComponent = props => {
 ...
 const { foundingSeller, greatCommunicator, partyPro, photoReadyListing, repartyInsider, superhost, topSeller, ecoFriendlyseller, communityFavorite } = currentUser?.attributes?.profile?.publicData || {};
  ...
  const handleSubmit = async (values, userType) => {
    ...
    const profile = {
      ...
      publicData: {
        ...
        foundingSeller:foundingSeller ||false,
        partyPro:partyPro||false,
        topSeller:topSeller||false,
        communityFavorite:communityFavorite||false,
        ecoFriendlyseller:ecoFriendlyseller||false,
        greatCommunicator:greatCommunicator||false,
        photoReadyListing:photoReadyListing||false,
        superhost:superhost||false,
        repartyInsider:repartyInsider||false,
  ...
  const { userType, address, city, state, zipCode, country } = publicData || {};
    ...
    <Page className={css.root} title={title} scrollingDisabled={scrollingDisabled}>
      ...
      >
        <div className={css.content}>
          <div className={css.headingContainer}>{profileSettingsForm}</div>
        </div>
      </LayoutSideNavigation>
    </Page>
  );
