...
import { loadData as MyPurchasesPageLoader } from './MyPurchases/MyPurchasesPage.duck';
import {
  loadData as TransactionPageLoader,
  setInitialValues as TransactionPageInitialValues,
} from './TransactionPage/TransactionPage.duck';
import { loadData as CartPageLoader } from './CartPage/CartPage.duck';
import { loadData as ContractorSearchPageLoader } from './AlgoliaSearchPage/ContractorSearchPage.duck';
...
const getPageDataLoadingAPI = () => {
  return {
    ...
    ContractorSearchPage: {
      loadData: ContractorSearchPageLoader,
    },
  };
};
