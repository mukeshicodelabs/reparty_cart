...
import NewListingSection from './NewListingSection/NewListingSection';
...
const SectionContainer = props => {
  const { className, rootClassName, id, as, children, appearance, options, listings, ...otherProps } = props;
  ...
  return (
    <Tag className={classes} id={id} {...otherProps}>
      ...
      <div className={css.sectionContent}>
        {id === "new-listings" ?
          <div className={css.newListingWrapper}>
            <NewListingSection options={options} />
          </div> :
          children
        }
      </div>
