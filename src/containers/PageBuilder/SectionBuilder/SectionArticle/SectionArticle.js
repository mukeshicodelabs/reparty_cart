...
import FeaturedCollectionsCard from '../SectionContainer/FeaturedCollectionsCard/FeaturedCollectionsCard';
import FaqSection from '../SectionContainer/FaqSection/FaqSection';
    ...
    >
      ...
      {hasBlocks ? (
        ...
        >
          ...
          <div>
            <FeaturedCollectionsCard options={options} />
          </div>:
          sectionId ==="faq-section"? 
          <div>
            <FaqSection />
            <div className={css.moreFaqLink}>
              <NamedLink name="FAQPage" className={css.faqLink}>More FAQs</NamedLink>
            </div>
            </div>:
           <BlockBuilder
            blocks={blocks}
