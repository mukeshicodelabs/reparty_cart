...
const ListingImageGallery = props => {
  ...
  const intl = useIntl();
  const { rootClassName, className, images, imageVariants, thumbnailVariants, previewGallery } = props;
  ...
  const renderItem = item => {
    return (
      <AspectRatioWrapper
        ...
        // className={classNames[ isFullscreen ? css.itemWrapperFullscreen : css.itemWrapper], css.previewGallery : previewGallery }
        className={classNames(isFullscreen ? css.itemWrapperFullscreen : css.itemWrapper,{ [css.previewGallery]: previewGallery })}
      >
