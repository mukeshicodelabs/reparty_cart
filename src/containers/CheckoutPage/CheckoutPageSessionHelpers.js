...
export const storedData = storageKey => {
  if (window && window.sessionStorage) {
    ...
    const isPotentiallyIncludedBookingDatesValid =  Array.isArray(bookingDates) && bookingDates.length
    ? bookingDates[0].bookingEnd && bookingDates[0].bookingStart
      :bookingDates ? isValidBookingDates(bookingDates)
      : true;
