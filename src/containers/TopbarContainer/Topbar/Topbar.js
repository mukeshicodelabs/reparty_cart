  ...
  return (
    <div className={classes}>
      ...
      <div className={classNames(mobileRootClassName || css.container, mobileClassName)}>
        ...
        /> */}
        <a href="/" className={css.mobileLogo}>
          {/* <img src={mobileLogo} /> */}
      ...
      <div className={css.desktop}>
        {!isAuthenticated &&
        (resolvedCurrentPage === 'SignupPage' || 'LoginPage' || 'LandingPage') ? (
          <div className={css.topBar}>
            <span className={css.leftText}>
              <BrandIconCard type="call" />
              <span className={css.phoneNumber}>
                <FormattedMessage id="Topbar.contactNumber" />
              </span>
            </span>
            <span className={css.rightText}>
              <NamedLink name="LandingPage">
                <FormattedMessage id="Topbar.contactSupport" />
              </NamedLink>
            </span>
          </div>
        ) : null}
