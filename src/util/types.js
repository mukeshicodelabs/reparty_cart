...
export const MATCHES_TAB = "matches";
export const SEARCH_TAB = "allSearch";
export const CONTRACTOR_TYPE = "Contractors";
export const PROJECT_TYPE = "Projects";
...
export const SELL_PRODUCT = "sell-purchase";
export const RENT_PRODUCT = "Rental_booking"
...
export { propTypes };
// Search tabs for tranasctions 
export const MYPURCHASE= "viewPurchases"
export const MYRENT= "rent"
