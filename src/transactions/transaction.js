...
import * as purchaseProcessCart from './transactionProcessPurchaseCart';
...
export const PURCHASE_PROCESS_NAME_CART = 'default-purchase-cart';
...
const PROCESSES = [
  ...
  {
    name: PURCHASE_PROCESS_NAME_CART,
    alias: `${PURCHASE_PROCESS_NAME_CART}/release-1`,
    process: purchaseProcessCart,
    unitTypes: [ITEM],
  },
  {
...
export const resolveLatestProcessName = processName => {
  switch (processName) {
    ...
    case PURCHASE_PROCESS_NAME_CART:
      return PURCHASE_PROCESS_NAME_CART;
