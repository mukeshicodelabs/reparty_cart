...
export const transitions = {
  ...
  MARK_RECEIVED_FROM_PURCHASED: 'transition/mark-order-receive',
  ...
  CUSTOMR_CANCEL_BOOKING: 'transition/cancel-booking-customer',
  PROVIDER_CANCEL_BOOKING: 'transition/cancel-booking-provider',
  CREATE_SHIPPING_LABEL: 'transition/create-shipping-label',
  MARK_PICKUP_RECEIVED: 'transition/mark-pickup-received',
};
...
export const graph = {
  ...
  states: {
    ...
    [states.PURCHASED]: {
      on: {
        [transitions.MARK_DELIVERED]: states.ORDER_DELIVERED,
        // [transitions.OPERATOR_MARK_SHIPPED]: states.SHIPPED, 
        [transitions.AUTO_CANCEL]: states.CANCELED,
        [transitions.CANCEL]: states.CANCELED,
        [transitions.CREATE_SHIPPING_LABEL]: states.SHIPPING_LABEL_CREATED,
        [transitions.PROVIDER_CANCEL_BOOKING]: states.CANCELED,
        [transitions.CUSTOMR_CANCEL_BOOKING]: states.CANCELED,
        [transitions.MARK_PICKUP_RECEIVED]: states.DELIVERED,
      },
    },
    [states.SHIPPING_LABEL_CREATED]: {
      on: {
         [transitions.OPERATOR_MARK_SHIPPED]: states.SHIPPED,  
      },
    },
    [states.ORDER_DELIVERED]: {
      on: {
          [transitions.MARK_RECEIVED_FROM_PURCHASED]: states.DELIVERED,  
      },
    },
    [states.SHIPPED]: {
      on: {
...
export const isRelevantPastTransition = transition => {
  return [
    ...
    transitions.CUSTOMR_CANCEL_BOOKING,
    transitions.PROVIDER_CANCEL_BOOKING,
    transitions.CREATE_SHIPPING_LABEL,
    transitions.MARK_PICKUP_RECEIVED,
  ].includes(transition);
};
