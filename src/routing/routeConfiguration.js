...
const ConfirmationPage = loadable(() => import(/* webpackChunkName: "ConfirmationPage" */ '../containers/ConfirmationPage/ConfirmationPage'));
...
const MyPurchasesPage = loadable(() => import(/* webpackChunkName: "MyPurchasesPage" */ '../containers/MyPurchases/MyPurchasesPage'));
...
const SplashPage = loadable(() => import(/* webpackChunkName: "SplashPage" */ '../containers/SplashPage/SplashPage'));

// Styleguide helps you to review current components and develop new ones
const StyleguidePage = loadable(() => import(/* webpackChunkName: "StyleguidePage" */ '../containers/StyleguidePage/StyleguidePage'));
const ContactSupportPage = loadable(() => import(/* webpackChunkName: "WelcomeListingPage" */ '../containers/ContactSupportPage/ContactSupportPage'));

const PolicyPage = loadable(() => import(/* webpackChunkName: "WelcomeListingPage" */ '../containers/PoliciesPage/PolicyPage'));

const FAQPage = loadable(() => import(/* webpackChunkName: "InboxPage" */ '../containers/FAQPage/FAQPage'));

const CartPage = loadable(() => import(/* webpackChunkName: "CartPage" */ '../containers/CartPage/CartPage'));
const ContractorSearchPage = loadable(() => import(/* webpackChunkName: "ContractorSearchPage" */ '../containers/AlgoliaSearchPage/ContractorSearchPage'));
const ContactUsPage = loadable(()=> import(/* webpackChunkName: "ContactUsPage" */ '../containers/ContactUsPage/ContactUsPage'))
const OurStoryPage = loadable(()=> import(/* webpackChunkName: "OurStoryPage" */ '../containers/OurStoryPage/OurStoryPage'))
...
const routeConfiguration = (layoutConfig, accessControlConfig) => {
  ...
  return [
    ...
    {
      path: '/order/:id/checkout-confirmation',
    ...
    },
    {
      ...
      loadData: pageDataLoadingAPI.FavoritePage.loadData,
    },
     {
      path: '/my-purchases/:tab',
    ...
    },
    {
      ...
      component: ContractorSearchPage,
      loadData: pageDataLoadingAPI.ContractorSearchPage.loadData,
    },
      {
      path: '/search/:featured',
      name: 'ContractorSearchPageWithFeatured',
      component: ContractorSearchPage,
      loadData: pageDataLoadingAPI.ContractorSearchPage.loadData,
    },
    // {
